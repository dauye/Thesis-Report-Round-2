...
\chapter{Conclusion}
    ...
    From the dynamic calculation, the result shows that the origin EnergyPlus simulation showed a much lower energy consumption than the measured energy consumption. This is partly because of a wrong assumption on building air-tightness. In addition, the performance gap on annual heating demand is getting closer when the building envelope is less air-tight, which indicates a probability of over-estimated internal loads.\\
